// filepath: /c:/Cawu 4 - Software Engineering/mealthy/app/screens/6.2_BookmarkPage.js
              ...
              <TouchableOpacity 
                ...
                <View style={styles.recipeTextContainer}>
                  ...
                  <View style={styles.iconContainer}>
                    ...
                    <Text style={styles.recipeDetails}>{item.time}</Text>
                    <Text style={styles.separator}> | </Text>
                    <FontAwesome5 name="fire" size={14} color="#777" />
                    <Text style={styles.recipeDetails}>{item.calories}</Text>
                  </View>
                </View>
              </TouchableOpacity>
            ))}
