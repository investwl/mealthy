...
// import ScannerPage from './ScannerPage'; // No need to import ScannerPage, you are navigating
...
import { recognize } from 'react-native-tesseract-ocr'; // Import the OCR library
      ...
      if (imageUri) {
        try {
            const tesseractOptions = {
                whitelist: null, // Or, if possible, limit the alphabet to improve accuracy
                blacklist: null
            };
            const result = await recognize(imageUri, "ENG", tesseractOptions);  // "ENG" for English, adapt as needed
